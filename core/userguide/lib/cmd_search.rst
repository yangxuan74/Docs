...
Search for library in `PlatformIO Library Registry <https://www.os-q.com/lib>`_
...
2. Search for `1-Wire libraries <https://www.os-q.com/lib/search?query=%25221-wire%2522>`_
...
3. Search for `Arduino-based "I2C" libraries <https://www.os-q.com/lib/search?query=framework%253Aarduino%2520i2c>`_
...
4. Search for `libraries by "web" and "http" keywords <https://www.os-q.com/lib/search?query=keyword%253A%2522web%2522%2520keyword%253A%2522http%2522>`_.
...
5. Search for `libraries by "Adafruit Industries" author <https://www.os-q.com/lib/search?query=author%253A%2522Adafruit%20Industries%2522>`_
...
6. Search for `libraries which are compatible with Dallas temperature sensors <https://www.os-q.com/lib/search?query=DS*>`_
...
7. Search for `Energia-based *nRF24* or *HttpClient* libraries <https://www.os-q.com/lib/search?query=framework%253Aenergia%2520%252B(nRF24%2520HttpClient)>`_.
...
8. Search for the `all sensor libraries excluding temperature <https://www.os-q.com/lib/search?query=sensor%2520-temperature>`_.
