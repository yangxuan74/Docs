...
or ``littlefs.bin``. You can change the file name using `a PRE extra script <https://docs.OS-Q.com/en/latest/projectconf/advanced_scripting.html#before-pre-and-after-post-actions>`_, for example:
